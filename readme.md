...
https://github.com/user-attachments/assets/069130ff-03a4-4e2b-8cc1-116c9df500ab
...
<img width="597" height="631" alt="plus" src="https://github.com/user-attachments/assets/3657672a-19fc-4163-b2a9-158ae81da397" />

Example of plus optimization with randomly generated circles with noise.


<img width="500" height="833" alt="plusBoard" src="https://github.com/user-attachments/assets/0f135972-63c3-4287-a6bb-4fa1668b03c0" />

Example for our board.
...
<img width="501" height="835" alt="boardFields" src="https://github.com/user-attachments/assets/2161c7f9-4e8e-436b-b4c5-291a92887cc0" />

Fields found using this method.
...
## Board vizualisation
Board vizualisation was added to help with understanding what is goint on according to our algorithm, since information like "moved from field 37 to 40" doesn't give much informations. Vizualisaion contains all fields, and highlighted start fields for each color.
...
### Counting amount of pawns in base
We tried counting amount of pawns in bases by finding bases, and rotating them five times, calculating SSIM over each rotation. It gave some promising results, but had too much noise and we were not able to get meaningful informations from them.
